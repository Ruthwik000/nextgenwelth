...
export default function EmailTemplate({
  ...
  if (type === "large-transaction-alert") {
    return (
      <Html>
        <Head />
        <Preview>Large Transaction Alert</Preview>
        <Body style={styles.body}>
          <Container style={styles.container}>
            <Heading style={styles.title}>Large Transaction Alert</Heading>
            <Text style={styles.text}>Hello {userName},</Text>
            <Text style={styles.text}>
              We detected a large transaction on your account.
            </Text>
            ...
            <Text style={styles.footer}>
              Thank you for using Welth. We're committed to helping you manage your finances.
            </Text>
          </Container>
        </Body>
      </Html>
